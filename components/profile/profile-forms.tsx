  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      <div className="flex items-center gap-2 px-5 py-3.5 border-b border-slate-100 bg-slate-50">
        ...
        <h2 className="text-sm font-semibold text-slate-900">Имя</h2>
      </div>
      <form
        action={(fd) =>
    ...
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      ...
      <div className="p-5 space-y-4">
        {currentEmail ? (
          <div className="flex items-center justify-between gap-3 rounded-lg bg-slate-50 border border-slate-200 px-4 py-3">
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-slate-900 truncate">{currentEmail}</p>
          ...
          <p className="text-sm text-slate-500">Email не указан</p>
        )}
        ...
        <form
          ...
          className="space-y-2"
        >
          <label className="block text-xs text-slate-500">Сменить email на новый</label>
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
      <div className="flex items-center gap-2 px-5 py-3.5 border-b border-slate-100 bg-slate-50">
        ...
        <h2 className="text-sm font-semibold text-slate-900">Пароль</h2>
      </div>
      ...
      >
        ...
        <div>
          <label className="block text-xs text-slate-500 mb-1">Новый пароль (минимум 8 символов)</label>
          <input
            type={show ? "text" : "password"}
            name="newPassword"
            minLength={8}
