...
//
// ЯЗЫК: весь текст ниже — сам документ (шапка, пункты, приложения, подписи
// сторон), поэтому он остаётся русским. Казахская редакция выходит только после
// вычитки юриста, а подписанные договоры воспроизводятся байт-в-байт
