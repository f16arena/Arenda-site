...
const VIEWS: { l: keyof Messages["adminBuilder"]["camera"]; a: number; b: number }[] = [
  { l: "viewTop", a: -Math.PI / 2, b: 0.02 },
  { l: "viewFront", a: -Math.PI / 2, b: B },
  { l: "viewBack", a: Math.PI / 2, b: B },
  { l: "viewLeft", a: 0, b: B },
  { l: "viewRight", a: Math.PI, b: B },
  { l: "viewIso", a: -Math.PI / 4, b: Math.PI / 3.2 },
]
