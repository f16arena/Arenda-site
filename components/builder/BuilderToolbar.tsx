...
const TOOLS: Item[] = [
  ...
  { id: "door", label: "Дверь", key: "D", Icon: Box, phase1: false },
  { id: "window", label: "Окно", key: "N", Icon: Eye, phase1: false },
  { id: "stair", label: "Лестница", key: "S", Icon: ArrowUpFromLine, phase1: false },
  { id: "roof", label: "Крыша", key: "T", Icon: Building2, phase1: false },
  { id: "object", label: "Объект", key: "O", Icon: Box, phase1: false },
  { id: "material", label: "Материал", key: "M", Icon: Scissors, phase1: false },
