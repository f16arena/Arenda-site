// Экран главной: данные и разметка одни, язык приходит параметром.
// Русская версия — /, казахская — /kk (адрес нужен поиску).
  ...
  return (
    <>
      ...
      <link
        ...
        rel="stylesheet"
      />
      <LandingV2 pricing={pricing} founding={founding} editorImageUrl={editorImageUrl} dashboardUrl={dashboardUrl} locale={locale} />
    </>
  )
}
