...
export const catalogs: typeof ru = {
  ...
  validation: {
    ...
    passwordShort: "Құпиясөз кемінде 6 таңба",
    contactRequired: "Email немесе телефон нөмірін көрсетіңіз",
    currentPassword: "Қазіргі құпиясөзді енгізіңіз",
    newPasswordShort: "Жаңа құпиясөз кемінде 8 таңба",
    passwordsMismatch: "Құпиясөздер сәйкес келмейді",
    newPasswordSame: "Жаңа құпиясөз қазіргіден өзгеше болуы керек",
