...
//
// ЯЗЫК: суммы прописью и даты идут в текст договора, счёта и АВР — остаются
// русскими. В казахском другое согласование числительных, и такую сумму
// обязан выверить юрист (docs/i18n-documents-plan.md).
