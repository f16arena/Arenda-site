...
//
// По той же причине не переводится size — марка кабеля, диаметр трубы и сечение
// воздуховода по умолчанию («ВВГнг(А)-LS 3×2,5», «ПП Ø110», «Сталь Ду20»,
// «U/UTP кат. 6»). Это обозначения по ГОСТ и ТУ: проектировщик читает их как
// артикул, а не как фразу, и в спецификации они должны совпадать с каталогом
// поставщика посимвольно. Значение к тому же редактируемое — владелец ставит
// свою марку.
