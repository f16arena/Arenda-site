// `label` у команды — служебная подпись для склейки drag'а и для отладки стека
// undo/redo. В интерфейсе она не отрисовывается (проверено grep-ом), поэтому
// остаётся русской и в словарь не переносится.
//
