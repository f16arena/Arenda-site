...
// Старый генератор «Акт сверки» убран 19.09.2026: документ создаётся в конструкторе
...
export default async function LegacyDocumentPage({
  ...
  redirect(`/admin/documents?create=reconciliation${tenantId ? `&tenantId=${encodeURIComponent(tenantId)}` : ""}`)
}
