...
// Старый генератор «Счёт» убран 19.09.2026: документ создаётся в конструкторе
...
export default async function LegacyDocumentPage({
  ...
  redirect(`/admin/documents?create=invoice${tenantId ? `&tenantId=${encodeURIComponent(tenantId)}` : ""}`)
}
