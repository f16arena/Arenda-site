    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-emerald-50 border border-blue-200 rounded-2xl p-6">
        <div className="flex items-start gap-4">
          <div className="h-12 w-12 rounded-xl bg-white border border-blue-200 flex items-center justify-center shrink-0">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-slate-500 mt-2">
              Тариф: <span className="font-medium text-slate-700">{org?.plan?.name ?? "—"}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-semibold text-slate-900">Запуск за 4 шага</h2>
          <p className="text-sm text-slate-500">{doneCount} из {steps.length} готово</p>
        </div>
          ...
          {steps.map((s, i) => (
            <li key={i}>
              ...
              >
                ...
                <div className="flex-1">
                  <p className={`text-sm font-medium ${s.done ? "text-emerald-900" : "text-slate-900"}`}>
                    {s.label}
                  </p>
                </div>
                <ArrowRight className={`h-4 w-4 ${s.done ? "text-emerald-600" : "text-slate-400"}`} />
              </Link>
            </li>
          ))}
        </ol>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-900">Импорт из Excel</p>
        ...
        <Link
          ...
          className="bg-white rounded-2xl border border-slate-200 p-5 hover:border-purple-300 hover:shadow-sm transition group"
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-900">Создать здание</p>
              <p className="text-xs text-slate-500 mt-1">
      ...
      <p className="text-center text-xs text-slate-400">
        Можете <Link href="/admin" className="underline hover:text-slate-600">пропустить и сразу перейти в систему</Link>
      </p>
