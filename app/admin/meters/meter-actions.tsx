        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xs">
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
              ...
              <button onClick={() => setOpen(false)}><X className="h-4 w-4 text-slate-400" /></button>
            </div>
            <form
            ...
            >
              ...
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1.5">Текущее показание *</label>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm">
            ...
            >
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1.5">Счётчик *</label>
                <select name="meterId" required className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm bg-white focus:border-blue-500 focus:outline-none">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm">
            ...
            >
              <div>
                ...
                <select name="spaceId" required className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm bg-white focus:border-blue-500 focus:outline-none">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select name="type" className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm bg-white focus:border-blue-500 focus:outline-none">
