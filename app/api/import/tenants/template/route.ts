...
export async function GET() {
  ...
  const examples = [
    ...
    {
      contactName: "Сидоров Сергей Сергеевич",
      phone: "+7 702 222 33 44",
      email: "sidorov@example.kz",
      companyName: "ЧСИ Сидоров Сергей Сергеевич",
      legalType: "ЧСИ",
      bin: "930510300006",
      category: "частный судебный исполнитель",
      legalAddress: "г. Астана, ул. Кабанбай батыра 10",
